        ...
        {carouselItems.map(
          ({ id, imageUrl, name, href, description, title, logo }) => {
            return (
              ...
              >
                <div
                  className="absolute w-full h-[50px] md:h-[80vh] z-[2] opacity-[.62] rounded-[5px]"
                  style={{
                ...
                <img
                  src={imageUrl}
                  className="bg-cover w-full h-[50px] md:h-[80vh] bg-[#181818] aspect-w-1 aspect-h-1 rounded-[5px] overflow-hidden transform transition duration-500 hover:cursor-pointer object-cover"
                  alt={name}
                />
