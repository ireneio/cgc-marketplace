...
const languages = [
  ...
  { text: 'Japanese', value: 'ja_JP' },
  { text: 'English', value: 'es' },
];
      ...
      >
        <div className="pb-8 xl:grid xl:grid-cols-5 xl:gap-8">
          <div className="grid grid-cols-2 gap-8 xl:col-span-4">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <FooterVerticalList
                title="Solutions"
                itemList={navigation.solutions}
              />
              <div className="mt-12 md:mt-0">
                <FooterVerticalList
                  title="Support"
                  itemList={navigation.support}
                />
              </div>
            </div>
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <FooterVerticalList
                title="Company"
                itemList={navigation.company}
              />
              <div className="mt-12 md:mt-0">
                <FooterVerticalList title="Legal" itemList={navigation.legal} />
              </div>
            </div>
          </div>
        ...
        <div className="pt-8 md:flex md:items-center md:justify-between">
          <div className="flex space-x-6 md:order-2">
            {navigation.social.map((item) => (
              <a
                key={item.name}
                href={item.href}
                className="text-[#FFFFFF] hover:text-[#FC1F8E]"
              >
          ...
          <p className="mt-8 text-base text-[#9497AA] md:mt-0 md:order-1">
            &copy; {dayjs().format('YYYY')} {brandInfo.name} All rights
            reserved.
          </p>
        </div>
      </div>
